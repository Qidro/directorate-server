...
from models import User, ProjectIndicators


class ProjectIndicatorsLog(BaseModel):
    ...
    def fetch(cls, condition=None, order_by=None, offset=None, limit=None):
        from models import ProjectIndicators, User

        project_log = (
            cls
            .select(cls, ProjectIndicators, User)
            .join_from(cls, ProjectIndicators, on=(cls.indicator == ProjectIndicators.id))
    ...
    class Meta:
        db_table = 'project_indicator_log'
